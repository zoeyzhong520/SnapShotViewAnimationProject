...
///宽度缩放比
let SCALE_X = ScreenSize.width / 375
...
///UITableView的通用reuseIdentifier
let BaseTableReuseIdentifier = "BaseTableReuseIdentifier"

///UICollectionView的通用reuseIdentifier
let BaseCollectReuseIdentifier = "BaseCollectReuseIdentifier"
